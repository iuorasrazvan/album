<?php 
	...
	public function testIndexActionCanBeAccessed()   {
		...
		$this->assertControllerName('albumController');
	...
	public function testAddActionRedirectsAfterValidPost()  {
		...
		$this->assertResponseStatusCode(301);
		$this->assertRedirectTo('/login?message=need%2011111111111111111111111111111111111111111111111111111111111111111111111111111login&redirect=/login');
